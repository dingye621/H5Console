(function(w){
	w.globalConfig = {
			...
			risk:{type:4,load:['#FF000090','#FFF68F90','#0000FF90','#EE762190'],name:'Risk'},//风险分区四色图  黄色
			...
			redColor:'#FF000080',//四级  红色
			yellowColor:'FFF68F80',//二级  黄色
			blueColor:'#0000FF90',//一级  蓝色
			orangeColor:'#EE762180',//三级  橙色
			colorCode:'COLOR',
	};
	return w;
})(window || {});
